...
import { Settings as SettingsIcon, ShowChart, AccountBalance, History } from '@mui/icons-material';
...
function AppHeader() {
  ...
  const showHeader = ['/', '/portfolio', '/history'].includes(location.pathname);
...
function BottomNav() {
  ...
  const showNav = ['/', '/portfolio', '/history'].includes(location.pathname);
  ...
  return (
    <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0 }} elevation={3}>
      <BottomNavigation
        ...
        showLabels
      >
        <BottomNavigationAction label="シグナル" icon={<ShowChart />} />
